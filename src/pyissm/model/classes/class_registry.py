...
def register_class(cls):
    ...
    .. code-block:: python
        ...
        # To register a class, simply decorate it with @register_class
        @register_class
...
def map_classtype(classtype):
    """
    Map legacy class types to modern hierarchical class names for backwards compatibility.

    This function provides a mapping from old/MATLAB ISSM class naming conventions to the
    new Python modular naming scheme. It ensures that legacy model files can still
