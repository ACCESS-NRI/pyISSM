...
class amr(class_registry.manage_state):
    ...
    def __repr__(self):
        ...
        s += '{}\n'.format(class_utils._field_display(self, 'hmin', 'minimum element length'))
        s += '{}\n'.format(class_utils._field_display(self, 'hmax', 'maximum element length'))
        s += '{}\n'.format(class_utils._field_display(self, 'fieldname', 'name of input that will be used to compute the metric (should be an input of FemModel)'))
        s += '{}\n'.format(class_utils._field_display(self, 'keepmetric', 'indicates whether the metric should be kept every remeshing time'))
        s += '{}\n'.format(class_utils._field_display(self, 'gradation', 'maximum ratio between two adjacent edges'))
        s += '{}\n'.format(class_utils._field_display(self, 'groundingline_resolution', 'element length near the grounding line'))
        s += '{}\n'.format(class_utils._field_display(self, 'groundingline_distance', 'distance around the grounding line which elements will be refined'))
        s += '{}\n'.format(class_utils._field_display(self, 'icefront_resolution', 'element length near the ice front'))
        s += '{}\n'.format(class_utils._field_display(self, 'icefront_distance', 'distance around the ice front which elements will be refined'))
        s += '{}\n'.format(class_utils._field_display(self, 'thicknesserror_resolution', 'element length when thickness error estimator is used'))
        s += '{}\n'.format(class_utils._field_display(self, 'thicknesserror_threshold', 'maximum threshold thickness error permitted'))
        s += '{}\n'.format(class_utils._field_display(self, 'thicknesserror_groupthreshold', 'maximum group threshold thickness error permitted'))
        s += '{}\n'.format(class_utils._field_display(self, 'thicknesserror_maximum', 'maximum thickness error permitted'))
        s += '{}\n'.format(class_utils._field_display(self, 'deviatoricerror_resolution', 'element length when deviatoric stress error estimator is used'))
        s += '{}\n'.format(class_utils._field_display(self, 'deviatoricerror_threshold', 'maximum threshold deviatoricstress error permitted'))
        s += '{}\n'.format(class_utils._field_display(self, 'deviatoricerror_groupthreshold', 'maximum group threshold deviatoric stress error permitted'))
        s += '{}\n'.format(class_utils._field_display(self, 'deviatoricerror_maximum', 'maximum deviatoricstress error permitted'))
        s += '{}\n'.format(class_utils._field_display(self, 'restart', 'indicates if ReMesh() will call before first time step'))
        return s
    ...
    def check_consistency(self, md, solution, analyses):
        ...
        class_utils._check_field(md, fieldname = "amr.hmax", scalar = True, gt = 0, allow_nan = False)
        class_utils._check_field(md, fieldname = "amr.hmin", scalar = True, gt = 0, lt = self.hmax, allow_nan = False)
        class_utils._check_field(md, fieldname = "amr.keepmetric", scalar = True, ge = 0, le = 1, allow_nan = False)
        class_utils._check_field(md, fieldname = "amr.gradation", scalar = True, ge = 1.1, le = 5, allow_nan = False)
        class_utils._check_field(md, fieldname = "amr.groundingline_resolution", scalar = True, gt = 0, lt = self.hmax, allow_nan = False)
        class_utils._check_field(md, fieldname = "amr.groundingline_distance", scalar = True, ge = 0, allow_nan = False, allow_inf = False)
        class_utils._check_field(md, fieldname = "amr.icefront_resolution", scalar = True, gt = 0, lt = self.hmax, allow_nan = False)
        class_utils._check_field(md, fieldname = "amr.icefront_distance", scalar = True, ge = 0, allow_nan = False, allow_inf = False)
        class_utils._check_field(md, fieldname = "amr.thicknesserror_resolution", scalar = True, gt = 0, lt = self.hmax, allow_nan = False)
        class_utils._check_field(md, fieldname = "amr.thicknesserror_threshold", scalar = True, ge = 0, le = 1, allow_nan = False)
        class_utils._check_field(md, fieldname = "amr.thicknesserror_groupthreshold", scalar = True, ge = 0, le = 1, allow_nan = False)
        class_utils._check_field(md, fieldname = "amr.thicknesserror_maximum", scalar = True, ge = 0, allow_nan = False, allow_inf = False)
        class_utils._check_field(md, fieldname = "amr.deviatoricerror_resolution", scalar = True, gt = 0, lt = self.hmax, allow_nan = False)
        class_utils._check_field(md, fieldname = "amr.deviatoricerror_threshold", scalar = True, ge = 0, le = 1, allow_nan = False)
        class_utils._check_field(md, fieldname = "amr.deviatoricerror_groupthreshold", scalar = True, ge = 0, le = 1, allow_nan = False)
        class_utils._check_field(md, fieldname = "amr.deviatoricerror_maximum", scalar = True, ge = 0, allow_nan = False, allow_inf = False)
        class_utils._check_field(md, fieldname = "amr.restart", scalar = True, ge = 0, le = 1, allow_nan = False)
