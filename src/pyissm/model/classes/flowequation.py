...
class flowequation(class_registry.manage_state):
    ...
    def check_consistency(self, md, solution, analyses):
        ...
        class_utils._check_field(md, fieldname = "flowequation.isSIA", scalar = True, values = [0, 1])
        class_utils._check_field(md, fieldname = "flowequation.isSSA", scalar = True, values = [0, 1])
        class_utils._check_field(md, fieldname = "flowequation.isL1L2", scalar = True, values = [0, 1])
        class_utils._check_field(md, fieldname = "flowequation.isMOLHO", scalar = True, values = [0, 1])
        class_utils._check_field(md, fieldname = "flowequation.isHO", scalar = True, values = [0, 1])
        class_utils._check_field(md, fieldname = "flowequation.isFS", scalar = True, values = [0, 1])
        class_utils._check_field(md, fieldname = "flowequation.isNitscheBC", scalar = True, values = [0, 1])
        class_utils._check_field(md, fieldname = "flowequation.FSNitscheGamma", scalar = True, ge = 0.0)
        class_utils._check_field(md, fieldname = 'flowequation.fe_SSA', values = ['P1', 'P1bubble', 'P1bubblecondensed', 'P2', 'P2bubble'])
        class_utils._check_field(md, fieldname = 'flowequation.fe_HO', values =  ['P1', 'P1bubble', 'P1bubblecondensed', 'P1xP2', 'P2xP1', 'P2', 'P2bubble', 'P1xP3', 'P2xP4'])
        class_utils._check_field(md, fieldname = 'flowequation.fe_FS', values = ['P1P1', 'P1P1GLS', 'MINIcondensed', 'MINI', 'TaylorHood', 'LATaylorHood', 'XTaylorHood', 'OneLayerP4z', 'CrouzeixRaviart', 'LACrouzeixRaviart'])
        class_utils._check_field(md, fieldname = 'flowequation.borderSSA', size = (md.mesh.numberofvertices, ), values = [0, 1])
        class_utils._check_field(md, fieldname = 'flowequation.borderHO', size = (md.mesh.numberofvertices, ), values = [0, 1])
        class_utils._check_field(md, fieldname = 'flowequation.borderFS', size = (md.mesh.numberofvertices, ), values = [0, 1])
        class_utils._check_field(md, fieldname = "flowequation.augmented_lagrangian_r", scalar = True, gt = 0.0)
        class_utils._check_field(md, fieldname = "flowequation.augmented_lagrangian_rhop", scalar = True, gt = 0.0)
        class_utils._check_field(md, fieldname = "flowequation.augmented_lagrangian_rlambda", scalar = True, gt = 0.0)
        class_utils._check_field(md, fieldname = "flowequation.augmented_lagrangian_rholambda", scalar = True, gt = 0.0)
        class_utils._check_field(md, fieldname = "flowequation.XTH_theta", scalar = True, ge = 0.0, lt = 0.5)

        if md.mesh.domain_type() == '2Dhorizontal':
            class_utils._check_field(md, fieldname = 'flowequation.vertex_equation', size = (md.mesh.numberofvertices, ), values = [1, 2, 4])
            class_utils._check_field(md, fieldname = 'flowequation.element_equation', size = (md.mesh.numberofelements, ), values = [1, 2, 4])
        elif md.mesh.domain_type() == '3Dsurface':
            class_utils._check_field(md, fieldname = 'flowequation.vertex_equation', size = (md.mesh.numberofvertices, ), values = np.arange(1, 2 + 1))
            class_utils._check_field(md, fieldname = 'flowequation.element_equation', size = (md.mesh.numberofelements, ), values = np.arange(1, 2 + 1))
        elif md.mesh.domain_type() == '2Dvertical':
            class_utils._check_field(md, fieldname = 'flowequation.vertex_equation', size = (md.mesh.numberofvertices, ), values = [2, 5, 6])
            class_utils._check_field(md, fieldname = 'flowequation.element_equation', size = (md.mesh.numberofelements, ), values = [2, 5, 6])
        elif md.mesh.domain_type() == '3D':
            class_utils._check_field(md, fieldname = 'flowequation.vertex_equation', size = (md.mesh.numberofvertices, ), values = np.arange(0, 9 + 1))
            class_utils._check_field(md, fieldname = 'flowequation.element_equation', size = (md.mesh.numberofelements, ), values = np.arange(0, 9 + 1))
        else:
