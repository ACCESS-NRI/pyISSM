...
class Model():
    ...
    def extrude(self,
        ...
        md.friction._extrude(md)
        md.inversion._extrude(md)
        md.smb._extrude(md)
        md.initialization._extrude(md)
        md.flowequation._extrude(md)
        md.stressbalance._extrude(md)
        md.thermal._extrude(md)
        md.masstransport._extrude(md)
        md.levelset._extrude(md)
        md.calving._extrude(md)
        md.frontalforcings._extrude(md)
        md.hydrology._extrude(md)
        md.debris._extrude(md)
        md.solidearth._extrude(md)
        md.dsl._extrude(md)
        md.stochasticforcing._extrude(md)
        md.materials._extrude(md)
        md.damage._extrude(md)
        md.mask._extrude(md)
        md.qmu._extrude(md)
        md.basalforcings._extrude(md)
        md.outputdefinition._extrude(md)
