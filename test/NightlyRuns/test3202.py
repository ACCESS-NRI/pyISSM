...
for i in range(0, len(md.results.TransientSolution)):
    ...
    # 2) Vy square misfit
    od2 = pyissm.model.classes.cfsurface.cfsurfacesquare()
    ...
    od3 = pyissm.model.classes.cfsurface.cfsurfacesquare()
    ...
    od4 = pyissm.model.classes.cfsurface.cfsurfacesquare()
