...
md = pyissm.model.mesh.round_mesh(md, 750000., resolution)
md = pyissm.model.param.set_mask(md, None, None)  #We can not test iceshelves nor ice rises with this analytical solution
md = pyissm.model.param.parameterize(md, '../assets/Par/RoundSheetStaticEISMINT.py')
