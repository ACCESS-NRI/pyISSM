#Test Name: SquareSheetHydrologyLayerSSA
import pyissm
import numpy as np
...
# Hydrology Layer
md.stressbalance.ishydrologylayer = 1
...
md.hydrology.rheology_B_base = pyissm.tools.materials.cuffey(273.15 - 2) * np.ones(md.mesh.numberofvertices,)
