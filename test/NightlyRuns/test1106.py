...
for L in L_list:
    md = pyissm.model.mesh.triangle(md, "../assets/Exp/Square_{}.exp".format(L), L / 10.)  #size 3 * L
    md = pyissm.model.param.set_mask(md, None, None)  #ice sheet test
    md = pyissm.model.param.parameterize(md, '../assets/Par/ISMIPC.py')
