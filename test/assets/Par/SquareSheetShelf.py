...
# Initial velocity
x = np.array(pyissm.tools.archive.arch_read('../assets/Data/SquareSheetShelf.arch', 'x'))
y = np.array(pyissm.tools.archive.arch_read('../assets/Data/SquareSheetShelf.arch', 'y'))
vx = np.array(pyissm.tools.archive.arch_read('../assets/Data/SquareSheetShelf.arch', 'vx'))
vy = np.array(pyissm.tools.archive.arch_read('../assets/Data/SquareSheetShelf.arch', 'vy'))
index = np.array(pyissm.tools.archive.arch_read('../assets/Data/SquareSheetShelf.arch', 'index')).astype(int)
...
md = pyissm.model.bc.set_marine_ice_sheet_bc(md, '../assets/Exp/SquareFront.exp')
