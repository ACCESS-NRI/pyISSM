...
# Initial velocity
x = np.array(pyissm.tools.archive.arch_read('../assets/Data/SquareSheetConstrained.arch', 'x'))
y = np.array(pyissm.tools.archive.arch_read('../assets/Data/SquareSheetConstrained.arch', 'y'))
vx = np.array(pyissm.tools.archive.arch_read('../assets/Data/SquareSheetConstrained.arch', 'vx'))
vy = np.array(pyissm.tools.archive.arch_read('../assets/Data/SquareSheetConstrained.arch', 'vy'))
index = pyissm.tools.archive.arch_read('../assets/Data/SquareSheetConstrained.arch', 'index').astype(int)
...
md.materials.rheology_B = pyissm.tools.materials.nye(md.initialization.temperature, 1)
