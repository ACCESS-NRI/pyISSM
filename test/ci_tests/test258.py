...
# Parameterise model
md = pyissm.model.mesh.triangle(pyissm.model.Model(), '../assets/Exp/Square.exp', 350000./2)
...
md2 = pyissm.model.mesh.triangle(pyissm.model.Model(), '../assets/Exp/Square.exp', 350000.)
md2 = pyissm.model.param.set_mask(md2, 'all', None)
md2 = pyissm.model.param.parameterize(md2, '../assets/Par/SquareShelf.py')
...
if sys.version_info.major == 2:
    inputs = np.load('../assets/Data/gemb_input.npy', allow_pickle=True).item()
else:
    inputs = np.load('../assets/Data/gemb_input.npy', allow_pickle=True, encoding='bytes').item()
