...
# creating delta18o
delta18o = np.loadtxt('../assets/Data/delta18o.data')
...
md.initialization.enthalpy = np.zeros((md.mesh.numberofvertices))
...
md.materials.rheology_B = pyissm.tools.materials.cuffey(md.initialization.temperature).reshape(np.shape(md.initialization.temperature))
