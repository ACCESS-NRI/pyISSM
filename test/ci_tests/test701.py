...
md = pyissm.model.mesh.bamg_flowband(pyissm.model.Model(), x, b + h, b, hmax = 80.)

# Geometry
# NOTE: interp1d returns a function to be called on md.mesh.x
...
md.stressbalance.spcvx[np.where(md.mesh.vertex_flags(4))] = 0.
